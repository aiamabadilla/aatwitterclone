...
import "../../styles/pages/TweetboxModal.css";
...
const TweetboxModal = () => {
  ...
  return (
    <div className="tweetboxmodal">
      {uploading && (
        <CircularProgress className="tweetboxmodal__uploadProgress" />
      )}
      <form
        action=""
        onSubmit={handleTweetSubmit}
        className="tweetboxmodal__form"
      >
          ...
          <div className="form__preview">
            ...
            {preview && (
              <>
                ...
                <Button
                  className="form__imagePreviewCloseButtonModal"
